...
--cau b
select masp, tensp, tenhang, sl, mau, gia, donvitinh, mota
...
--cau e
select Nhap.sohdn, sanpham.masp, tensp, tenhang, sln, dongian, 
sl*dongian as tiennhap, mau, donvitinh, ngaynhap, 
tennv, tenphong
from nv join pnhap
...
--cau f
select Xuat.sohdx, sanpham.masp, tensp, tenhang, slx, gia, slx*gia as tienxuat, mau, donvitinh, ngayxuat, tennv, tenphong
from nv join pxuat
